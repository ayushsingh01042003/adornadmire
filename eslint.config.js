...
export default tseslint.config(
  {
    ignores: [
      "dist",
      "build",
      // Generated by `react-router typegen`; uses declare namespace and {} by
      // design and is not ours to lint.
      ".react-router",
    ],
  },
  {
      ...
      "react/no-unknown-property": [
        "error",
        {
          ignore: [
            ...
            "fetchpriority", // React 18 DOM attribute; fetchPriority triggers a runtime warning
          ],
        },
      ],
  ...
  {
    // Route modules are required to export meta/links/loader beside the
    // component, so the Fast Refresh single-export rule does not apply.
